"""
Syncs Master_HRS_SILVASSA_Imports_Purchase_Data.csv from Drive into
HRSImportPurchaseOrder / HRSImportPOLineItem. Header-only on Drive as of
2026-09-04 (no real HRS import POs yet) - this command still runs cleanly
against an empty file (0 rows seen, 0 changed), so the dashboard's KPIs show
0 for HRS rather than erroring.
